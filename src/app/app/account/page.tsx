    ...
    <div className="fade-in" style={{ display: "grid", gap: 20 }}>
      ...
      <div className="grid cols-3">
        <div className="stat card">
          <div className="value"><AnimatedCounter value={memberships.length} /></div>
          <div className="label">Clubs joined</div>
        </div>
        <div className="stat card">
          <div className="value"><AnimatedCounter value={totalPoints} /></div>
          <div className="label">Total points</div>
        </div>
        <div className="stat card">
          <div className="value"><AnimatedCounter value={totalCheckins} /></div>
        ...
        <div className="card">
          ...
          <div className="grid cols-3">
            <div className="stat" style={{ border: "none", boxShadow: "none", padding: 0 }}>
              <div className="value"><AnimatedCounter value={Math.round(totalSpend)} /></div>
              <div className="label">Total spent across clubs</div>
            </div>
            <div className="stat" style={{ border: "none", boxShadow: "none", padding: 0 }}>
              <div className="value"><AnimatedCounter value={coupons} /></div>
